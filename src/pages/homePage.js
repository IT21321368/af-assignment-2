...
import nasa3 from '../assets/nasa3.jpg'; 
import nasa4 from '../assets/nasa4.jpg'; 
import HeaderHome from './../components/header-home';
// const navigation1 = [
//   { name: 'Picture Of The Day', href: 'apod' },
//   { name: 'Mas Rover Photo', href: 'MasRoverPhoto' },
//   { name: 'Nasa Epic Images', href: 'EpicImage' }
    
// ]

const navigation2 = {
  main: [
    { name: 'NASA', href: 'https://www.nasa.gov/' },
    { name: 'APOD', href: 'apod' },
    { name: 'Mas Rover Photos', href: 'MasRoverPhoto' },
    { name: 'EPIC', href: 'EpicImage' },
    { name: 'Blogs', href: 'https://www.nasa.gov/nasa-blogs/' },
    { name: 'News & Events', href: 'https://www.nasa.gov/news/all-news/' },
  ],
  social: [
    {
      name: 'Facebook',
...
export default function Home() {
  ...
  return (
    <div className="bg-gray-900">
      {/* Header */}
      <HeaderHome mobileMenuOpen={mobileMenuOpen} setMobileMenuOpen={setMobileMenuOpen} />
      ...
      <div className="relative isolate overflow-hidden pt-14">
        ...
        <div className="mx-auto max-w-3xl py-32 sm:py-48 lg:py-56">
          ...
          <div className="text-center">
            <h1 className="text-5xl tracking-wide font-bold  text-white sm:text-7xl">
              Explore the Universe
            </h1>
            <p className="mt-6 font-mono text-lg leading-8 text-gray-300">
      ...
      <div className="mx-auto max-w-7xl px-6 lg:flex lg:px-8">
        <div className="mx-auto grid max-w-2xl grid-cols-1 gap-x-12 gap-y-16 lg:mx-0 lg:min-w-full lg:max-w-none lg:flex-none lg:gap-y-8">
          <div className="lg:col-end-1 lg:w-full lg:max-w-lg lg:pb-8">
            <h2 className="text-3xl font-bold text-gray-900 sm:text-5xl">What Is NASA?</h2>
    ...
    <footer className="bg-black">
      <div className="mx-auto max-w-7xl overflow-hidden px-6 py-20 sm:py-24 lg:px-8">
        <nav className="-mb-6 columns-2 sm:flex sm:justify-center sm:space-x-12" aria-label="Footer">
          {navigation2.main.map((item) => (
            <div key={item.name} className="pb-6">
              {item.name === 'NASA' || item.name === 'Blogs' || item.name === 'News & Events'? (
              <a href={item.href} className="text-gray-400 hover:text-gray-500" target="_blank" rel="noopener noreferrer">{item.name}</a>
            ) : (
              <a href={item.href} className="text-gray-400 hover:text-gray-500">{item.name}</a>
            )}
            </div>
          ))}
        </nav>
        ...
        <p className="mt-10 text-center text-xs leading-5 text-gray-500">
          &copy; 2024 NASA , Inc. All rights reserved.
        </p>
      </div>
    </footer>
